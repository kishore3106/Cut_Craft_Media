  ...
  useEffect(() => {
    videoRefs.current.forEach((video, index) => {
      if (video && video.readyState >= 2) {
        handleVideoLoad(COLLECTION_VIDEOS[index].id);
      }
    });
  }, []);
            ...
            return (
              ...
              >
                ...
                <video 
                  ...
                  className={`w-full h-full transition-opacity duration-500 ${video.format === 'horizontal' ? 'object-contain bg-black' : 'object-cover'}`}
                />
